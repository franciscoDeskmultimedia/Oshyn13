...
const SubNav = (props:any)=>{
    ...
    return(
        <div className={`subnav flex flex-wrap max-w-siteContainer w-[120rem]`}>
            <div className={`subnav_featured_content md:w-[32rem] md:block hidden`}>
                    ...
                    {subnavItems.map((item:any,index:any)=>{
                        return(
                            <li className=" w-full md:w-1/2 flex flex-wrap items-start" key={index}>
                                <Link className="flex flex-wrap items-start" href={item.link} prefetch={false}>
