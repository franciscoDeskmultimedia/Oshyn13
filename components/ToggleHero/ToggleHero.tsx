...
const ToggleHero = (props:any)=> {
    return (
        <section className={`${styles.toggle_hero} py-20 px-10 w-full -mt-40 pt-40 bg-background pb-24  z-0 flex flex-col justify-center`}>
            <div className="toggle-hero__inner max-w-siteContainer mx-auto px-9 mt-10">
                ...
                <div className="inner-homepage-hero max-w-siteContainer m-auto relative z-10 flex flex-col justify-center" >
                    ...
                    <Toggle option1='Blog' option2='Ebook'></Toggle>
                </div>
